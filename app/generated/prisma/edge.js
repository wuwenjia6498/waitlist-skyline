...
const config = {
  "generator": {
    ...
    "output": {
      "value": "G:\\000-cursor学习\\waitlist-skyline\\app\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "G:\\000-cursor学习\\waitlist-skyline\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://root:XWsp7LBxm93RwVg285Zc4Du6C1qn0flQ@sha1.clusters.zeabur.com:31529/zeabur"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Waitlist {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "abdc4ddba5cf75c729a4211aec1d9ed1ff57eb2f136d0b82c2f5693330bfcdcb",
  "copyEngine": true
}
config.dirname = '/'
